...
The RSP Notebook Aspect is intended to function as a cloud server for analyzing and processing Rubin/LSST data (beyond issuing Portal queries, which can be done in the RSP Portal Aspect) and without needing to download the Rubin/LSST data to any local machine.
